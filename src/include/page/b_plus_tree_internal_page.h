...
class BPlusTreeInternalPage : public BPlusTreePage {
 public:
  ...
  void MoveAllTo(BPlusTreeInternalPage *recipient, GenericKey *middle_key,
...
//  union {
//    std::pair<Key16, page_id_t> k16[0];
//    std::pair<Key32, page_id_t> k32[0];
//    std::pair<Key64, page_id_t> k64[0];
//    std::pair<Key128, page_id_t> k128[0];
//    std::pair<Key256, page_id_t> k256[0];
//  } KV_array_;
};
