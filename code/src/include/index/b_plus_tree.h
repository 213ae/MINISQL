...
#define BPlusTree BPlusTree<GenericKey, RowId, KeyProcessor>
 ...
 */
class BPlusTree {
  using InternalPage = BPlusTreeInternalPage<GenericKey, page_id_t, KeyProcessor>;
  using LeafPage = BPlusTreeLeafPage<GenericKey, RowId, KeyProcessor>;

public:
  explicit BPlusTree(index_id_t index_id, BufferPoolManager *buffer_pool_manager, const KeyProcessor &comparator,
  ...
  bool Insert(const GenericKey *key, const RowId &value, Transaction *transaction = nullptr);
...
private:
  void StartNewTree(const GenericKey *key, const RowId &value);

  bool InsertIntoLeaf(const GenericKey *key, const RowId &value, Transaction *transaction = nullptr);

  void InsertIntoParent(BPlusTreePage *old_node, const GenericKey *key, BPlusTreePage *new_node,
